...
do{
 ...
 if(isNaN(ciudad) == false){  // si la variable ciudad contiene un numero, la funcion 'isNaN' devuelve "false".
...
última.
*/
document.write(`mostramos las posiciones:<br><br>Primera:${ciudades[0]}<br>Tercera:${ ciudades[2]}<br>
...
● Escribe por pantalla el elemento que ocupa la segunda posición.
*/
document.write(`Èl elemento que ocupa la segunda posicion es:${ciudades[1]} <br>`);
document.write('<hr>');
/*
● Sustituye el elemento que ocupa la segunda posición por la ciudad de
'Barcelona'.
...
document.write(`Èl elemento que ocupa la segunda posicion  ahora es:${ciudades[1]} <br>`);